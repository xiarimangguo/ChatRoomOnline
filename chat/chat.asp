...
<%
Session("Page") = "http://"&Request.ServerVariables("Server_Name")&Request.ServerVariables("Url")&"?Inviter="&Request.QueryString("Inviter")&"&Partner="&Request.QueryString("Partner")
...
If Inviter <> "" Then
If Partner <> "" Then
If Session("UserNums") = CLng(Inviter) Then
Else
If Session("UserNums") = CLng(Partner) Then
Else
Response.Write("<br /><p style='font-size:1em;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Access Denied. <a href='javascript:void(0);'>Retry</a></p>")
Response.End
End If
End If
Else
Response.Write("<br /><p style='font-size:1em;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Invalid Request. <a href='javascript:void(0);'>Retry</a></p>")
Response.End
End If
Else
Response.Write("<br /><p style='font-size:1em;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Invalid Request. <a href='javascript:void(0);'>Retry</a></p>")
...
Ifr_Src = "http://fscache20.cooles.top/login/chats/Chat_"&Inviter&"_"&Partner&"_Bord.asp"
Else
If Fs.FileExists(Server.MapPath("/login/chats/Chat_"&Partner&"_"&Inviter&"_Bord.asp")) Then
Ifr_Src = "http://fscache20.cooles.top/login/chats/Chat_"&Partner&"_"&Inviter&"_Bord.asp"
Else
Response.Write("<br /><p style='font-size:1em;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Request Failed. <a href='javascript:void(0);'>Retry</a></p>")
Response.End
End If
End If
Lst_Src = "http://fscache20.cooles.top/login/chats/list.asp?Inviter="&Inviter&"&Partner="&Partner
Snd_Src = "http://fscache20.cooles.top/login/chats/sendmessage.asp?Inviter="&Inviter&"&Partner="&Partner
%>
<html>
<head>
<script>
...
<iframe src="<%=Ifr_Src%>" style="width:100%;height:100%;">
</iframe>
<div style="float:left;display:inline;width:100%;height:11%;">
<iframe src="<%=Snd_Src%>" style="width:100%;height:100%;"></iframe>
</div>
...
<iframe src="<%=Lst_Src%>" style="width:100%;height:100%;"></iframe>
</div>
</div>
</div>
